...
if($_POST)
{
	$to_email   	= "thebackyardbutler1@gmail.com"; //Recipient email, Replace with own email here
	...
	$headers = 'From: thebchfc'.'' . "\r\n" . // set manually to work with web host spam protection / email routing
	'Reply-To: '.$user_email.'' . "\r\n" .
	...
	if(!$send_mail)
	{
		...
		Hi '.$user_name .', Thank you for your message. We will contact you right away.</div>'));
		die($output);
	}
}
?>